...
the deployed evaluator recovers only 0.042951. The unresolved v2 problem is
therefore candidate generation and scoring learned jointly with retrieval,
verification, and propagation, not merely the generation of more candidate sets,
candidate-state features, post-hoc deployment gates, or a shallow selector-loss
replacement.
