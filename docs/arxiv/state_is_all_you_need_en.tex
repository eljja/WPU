...
jointly with retrieval and propagation, not merely the generation of more
candidate sets, candidate-state features, post-hoc deployment gates, or a
shallow selector-loss replacement.
