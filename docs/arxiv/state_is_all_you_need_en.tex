...
static gates, learned gates, and mechanism-aware adaptation: it finds zero
non-reference calibration-safe policies under cost proxy $\leq 0.25$, while the
cheapest non-reference calibration-safe policy has cost proxy 0.867725. This
turns P5 into a falsifiable routing target rather than a solved calibration
claim.
