...
regression-heavy \(K=16\) ablation reaches only 0.034751. An end-to-end
...
accept \(\leq 0.25\), and train-selected closure is 0.096833. The unresolved v2
problem is therefore candidate generation and scoring learned jointly with
retrieval and propagation, not merely the generation of more candidate sets,
