...
is 0.023029, and train-selected closure is 0.024989. The unresolved v2 problem
is therefore candidate generation and scoring learned jointly with retrieval,
verification, and propagation dynamics, not merely the generation of more
candidate sets, candidate-state features, post-hoc deployment gates,
verification-feature descriptors, or a shallow selector-loss replacement.
