...
\(N_{\mathrm{bg}}=512\), total \(N=517\) baseline-complete medium run adds
stronger large-state evidence: the best WPU reaches 0.387500 versus the best
baseline at 0.362500, with 67.400400 times lower forward latency than that
best-accuracy baseline. This is stronger than the earlier micro-screen, but it
is still one cup family, one-step, and small-margin. The separate higher-budget
WPU-only \(N_{\mathrm{bg}}=512\) extension remains systems feasibility evidence
because the graph-transformer baseline did not complete under the attempted
protocol.
