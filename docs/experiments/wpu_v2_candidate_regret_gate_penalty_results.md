...
The best closure is `0.123585` (`K=16`, `candidate_regret_gate`). P1 evaluates whether candidate-regret deployment closes the candidate-oracle gap while controlling harmful accepts. The conservative best under harmful-accept <= `0.25` is `0.083764` (`uncertainty_regret_gate`). The train-selected deployed best is `0.081253` (`K=16`).
