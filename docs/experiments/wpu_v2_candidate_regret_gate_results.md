...
The best closure is `0.329950` (`K=16`, `candidate_regret_gate_m0p005`). P1 evaluates whether candidate-regret deployment closes the candidate-oracle gap while controlling harmful accepts. The conservative best under harmful-accept <= `0.25` is `0.327146` (`candidate_regret_gate_m0p01`).
