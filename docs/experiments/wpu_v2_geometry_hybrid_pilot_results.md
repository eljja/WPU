# WPU v2 Geometry Hybrid Pilot

Source CSV: `docs/experiments/wpu_v2_geometry_hybrid_pilot.csv`
...
Short CPU runs are pipeline checks, not paper evidence. Treat accuracy near the
majority baseline as inconclusive until multi-seed, longer-step, GPU-scale runs
are available. The useful signal here is compute realism: geometry-only local
features avoid dense execution, but they do not yet recover the accuracy of the
interaction-hybrid path on the pairwise stress task.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| wpu-cws-indexed-geometry-hybrid | 2048 | 8 | 0 | pairwise | 248366 | 0.488889 | 0.333333 | 0.155556 | 0.012552 | 8.0 | 1.0 | 1.0 | 0.0 | 1.66036 | 19.518066 |
| wpu-cws-indexed-geometry-hybrid | 2048 | 8 | 0 | pairwise | 248366 | 0.444444 | 0.333333 | 0.111111 | 0.01271 | 8.0 | 1.0 | 1.0 | 0.0 | 1.653853 | 19.518066 |
| wpu-cws-indexed-geometry-hybrid | 2048 | 16 | 0 | pairwise | 248366 | 0.455556 | 0.333333 | 0.122223 | 0.009926 | 16.0 | 1.0 | 1.0 | 0.0 | 3.714867 | 19.692383 |
| wpu-cws-indexed-geometry-hybrid | 2048 | 16 | 0 | pairwise | 248366 | 0.588889 | 0.333333 | 0.255556 | 0.013888 | 16.0 | 1.0 | 1.0 | 0.0 | 3.483073 | 19.692383 |
| wpu-cws-indexed-geometry-hybrid | 2048 | 32 | 0 | pairwise | 248366 | 0.466667 | 0.333333 | 0.133334 | 0.010713 | 32.0 | 1.0 | 1.0 | 0.0 | 6.311777 | 20.325195 |
| wpu-cws-indexed-geometry-hybrid | 2048 | 32 | 0 | pairwise | 248366 | 0.5 | 0.333333 | 0.166667 | 0.015294 | 32.0 | 1.0 | 1.0 | 0.0 | 5.724923 | 20.325195 |
| wpu-cws-indexed-interaction-hybrid | 2048 | 8 | 0 | pairwise | 248108 | 0.566667 | 0.333333 | 0.233334 | 0.024584 | 8.0 | 1.0 | 0.852851 | 0.147149 | 2.338313 | 22.063965 |
| wpu-cws-indexed-interaction-hybrid | 2048 | 8 | 0 | pairwise | 248108 | 0.533333 | 0.333333 | 0.2 | 0.026268 | 8.0 | 1.0 | 0.851113 | 0.148887 | 2.02404 | 22.063965 |
| wpu-cws-indexed-interaction-hybrid | 2048 | 16 | 0 | pairwise | 248108 | 0.6 | 0.333333 | 0.266667 | 0.01924 | 16.0 | 1.0 | 0.836898 | 0.163102 | 3.403497 | 22.235352 |
| wpu-cws-indexed-interaction-hybrid | 2048 | 16 | 0 | pairwise | 248108 | 0.555556 | 0.333333 | 0.222223 | 0.022408 | 16.0 | 1.0 | 0.835124 | 0.164876 | 3.352313 | 22.235352 |
| wpu-cws-indexed-interaction-hybrid | 2048 | 32 | 0 | pairwise | 248108 | 0.733333 | 0.333333 | 0.4 | 0.014719 | 32.0 | 1.0 | 0.823278 | 0.176722 | 6.45191 | 23.039062 |
| wpu-cws-indexed-interaction-hybrid | 2048 | 32 | 0 | pairwise | 248108 | 0.688889 | 0.333333 | 0.355556 | 0.012492 | 32.0 | 1.0 | 0.824409 | 0.175591 | 5.929333 | 23.039062 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| wpu-cws-indexed-geometry-hybrid | 2048 | 8 | 0 | pairwise | 2 | 248366 | 0.466666 | 0.043556 | 0.333333 | 0.133333 | 0.012631 | 8.0 | 1.0 | 1.0 | 0.0 | 0.447842 | 1.657107 | 0.006377 |
| wpu-cws-indexed-geometry-hybrid | 2048 | 16 | 0 | pairwise | 2 | 248366 | 0.522223 | 0.130666 | 0.333333 | 0.18889 | 0.011907 | 16.0 | 1.0 | 1.0 | 0.0 | 0.287571 | 3.59897 | 0.227158 |
| wpu-cws-indexed-geometry-hybrid | 2048 | 32 | 0 | pairwise | 2 | 248366 | 0.483333 | 0.032666 | 0.333333 | 0.15 | 0.013004 | 32.0 | 1.0 | 1.0 | 0.0 | 0.227893 | 6.01835 | 0.575117 |
| wpu-cws-indexed-interaction-hybrid | 2048 | 8 | 0 | pairwise | 2 | 248108 | 0.55 | 0.032667 | 0.333333 | 0.216667 | 0.025426 | 8.0 | 1.0 | 0.851982 | 0.148018 | 0.437207 | 2.181176 | 0.307988 |
| wpu-cws-indexed-interaction-hybrid | 2048 | 16 | 0 | pairwise | 2 | 248108 | 0.577778 | 0.043555 | 0.333333 | 0.244445 | 0.020824 | 16.0 | 1.0 | 0.836011 | 0.163989 | 0.363522 | 3.377905 | 0.05016 |
| wpu-cws-indexed-interaction-hybrid | 2048 | 32 | 0 | pairwise | 2 | 248108 | 0.711111 | 0.043555 | 0.333333 | 0.377778 | 0.013605 | 32.0 | 1.0 | 0.823843 | 0.176156 | 0.476664 | 6.190621 | 0.512125 |
...
| --- | --- | --- | --- | --- | --- |
| 2048 | wpu-cws-indexed-interaction-hybrid | 0.711111 | 0.711111 | 6.190621 | 248108 |

## Best Accuracy By K

| K | model | accuracy_mean | accuracy | ms/sample | params |
| --- | --- | --- | --- | --- | --- |
| 8 | wpu-cws-indexed-interaction-hybrid | 0.55 | 0.55 | 2.181176 | 248108 |
| 16 | wpu-cws-indexed-interaction-hybrid | 0.577778 | 0.577778 | 3.377905 | 248108 |
| 32 | wpu-cws-indexed-interaction-hybrid | 0.711111 | 0.711111 | 6.190621 | 248108 |
