...
- P1 Candidate-oracle gap: Best deployed closure is 0.244220 and mean closure is 0.160601; decomposition shows no omitted aggregate policy closes the gap. Sample-level no-harm/margin gates were also audited; best closure is 0.082804, so margin gating is not the missing fix.
...
- P1: Move below aggregate policy selection: add per-candidate uncertainty, calibrated regret targets, and sample-level no-harm rejection losses.
