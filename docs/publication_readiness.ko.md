...
H=25 target-object MSE는 `357.220733`, branch accuracy는 `0.750000`으로 개선된다. 다음 단계는
더 큰 seed 검증과 더 강한 target-object transition dynamics다.
