...
2. Improve long-horizon state integrity, not only report it. Simple delta-norm,
   ...
   reduce that bottleneck. The next step is branch-conditioned local transition
   dynamics and stronger target-object transition heads.
