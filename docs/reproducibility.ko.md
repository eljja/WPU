...
저훈련 N_bg=512 matched micro-screen은 다음 명령으로 재현할 수 있다.
...
5-seed N_bg=512 matched medium benchmark는 다음 명령으로 재현할 수 있다.
...
Higher-budget 5-seed N_bg=512 matched benchmark는 다음 명령으로 재현할 수 있다.
