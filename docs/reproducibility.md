...
The medium-training N_bg=256 matched benchmark can be reproduced with:
...
The low-training N_bg=512 matched micro-screen can be reproduced with:
...
The 5-seed N_bg=512 matched medium benchmark can be reproduced with:
...
The N_bg=512 mechanism-diversity claim-boundary screens can be reproduced with:
...
python scripts/pybullet_learned_correction_trigger.py --train-seeds 17 19 23 --eval-seeds 11 13 --horizon 25 --background-objects 32 --steps 20 --sim-steps 120 --train-samples 24 --eval-samples 24 --batch-size 8 --hidden-dim 64 --num-heads 4 --working-set-size 12 --gate-steps 300 --gate-hidden-dim 32 --out docs/experiments/pybullet_learned_correction_trigger.csv --out-md docs/experiments/pybullet_learned_correction_trigger_results.md --out-ko-md docs/experiments/pybullet_learned_correction_trigger_results.ko.md
python scripts/pybullet_stable_transition_sweep.py --out docs/experiments/pybullet_stable_transition_sweep.csv --out-md docs/experiments/pybullet_stable_transition_sweep_results.md --out-ko-md docs/experiments/pybullet_stable_transition_sweep_results.ko.md
```
...
python scripts/retriever_cross_seed_joint_utility_verifier_probe.py --out docs/experiments/wpu_v2_joint_utility_verifier.csv
python scripts/analyze_candidate_regret_gate.py --input docs/experiments/wpu_v2_joint_utility_verifier.csv --out-csv docs/experiments/wpu_v2_joint_utility_verifier_summary.csv --out-md docs/experiments/wpu_v2_joint_utility_verifier_results.md --out-ko-md docs/experiments/wpu_v2_joint_utility_verifier_results.ko.md
python scripts/analyze_candidate_safety_frontier.py --inputs docs/experiments/wpu_v2_candidate_regret_gate_summary.csv docs/experiments/wpu_v2_candidate_regret_gate_perturbed_summary.csv docs/experiments/wpu_v2_candidate_regret_gate_penalty_summary.csv docs/experiments/wpu_v2_candidate_regret_crossfit_summary.csv docs/experiments/wpu_v2_end_to_end_candidate_selector_summary.csv docs/experiments/wpu_v2_joint_utility_verifier_summary.csv --labels direct perturbed penalty crossfit end_to_end joint_utility
