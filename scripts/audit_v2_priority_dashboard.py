...
def _priority_simulator_grounding() -> dict[str, object]:
    ...
    return _row(
        ...
        "Upgrade the N_bg=512 medium run to higher training budgets, add mechanisms, and add long-horizon simulator rollouts.",
    )
...
def _ko_next_action(priority: int) -> str:
    return {
        ...
        3: "N_bg=512 medium run을 더 높은 training budget으로 승격하고, 더 많은 mechanism, long-horizon simulator rollout, perception/state adapter를 추가한다.",
