...
def _priority_candidate_oracle_gap() -> dict[str, object]:
    ...
    if end_to_end_path.exists():
        ...
        end_to_end_note = (
            f" End-to-end downstream-loss selector training is also a negative result for P1: "
